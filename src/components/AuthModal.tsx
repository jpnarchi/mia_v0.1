...
import { Mail, Lock, X, Eye, EyeOff, ArrowRight, User } from 'lucide-react';
...
export const AuthModal: React.FC<AuthModalProps> = ({ 
  ...
  const handleRegisterClick = () => {
    ...
    onNavigateToRegister(); // Navigate to registration page
  };
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-10 block w-full rounded-lg border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500 transition-all duration-200"
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-10 pr-10 block w-full rounded-lg border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500 transition-all duration-200"
                  placeholder="••••••••"
                  required
                />
                <button
